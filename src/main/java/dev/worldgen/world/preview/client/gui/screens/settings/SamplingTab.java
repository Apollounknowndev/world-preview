...
import static dev.worldgen.world.preview.client.WorldPreviewComponents.SETTINGS_SAMPLE_HEAD;
import static dev.worldgen.world.preview.client.WorldPreviewComponents.SETTINGS_SAMPLE_PIXELS_TITLE_1;
import static dev.worldgen.world.preview.client.WorldPreviewComponents.SETTINGS_SAMPLE_PIXELS_TITLE_2;
import static dev.worldgen.world.preview.client.WorldPreviewComponents.SETTINGS_SAMPLE_SAMPLE_TITLE_1;
import static dev.worldgen.world.preview.client.WorldPreviewComponents.SETTINGS_SAMPLE_SAMPLE_TITLE_2;
import static dev.worldgen.world.preview.client.WorldPreviewComponents.SETTINGS_SAMPLE_TITLE;
...
public class SamplingTab extends GridLayoutTab {
    public SamplingTab(Minecraft minecraft) {
        ...
        final RenderSettings renderSettings = WorldPreview.renderSettings();
