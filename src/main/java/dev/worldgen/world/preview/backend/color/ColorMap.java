...
public class ColorMap {
    ...
    /**
     * Calculates the entry for a given position in the colormap.
     *
    ...
    /**
     * Convert a entry from L*ab space to sRGB space
     *
     * @param L the L component
     * @param a the a component
     * @param b the b component
     * @return a 3-component float array containing the entry in rgb space
     */
    ...
    /**
     * Convert a entry from sRGB space to L*ab space
     *
     * @param r the red value (0-1)
     * @param g the green value (0-1)
     * @param b the blue value (0-1)
     * @return a 3-component float array with the entry in L*ab space
     */
     ...
     *
     * @param lower  Lower entry to interpolate from
     * @param upper  Higher entry to interpolate to
     * @param amount The amount to interpolate between the two colors
     * @return A new entry interpolated in L*ab space between lower and upper
     */
