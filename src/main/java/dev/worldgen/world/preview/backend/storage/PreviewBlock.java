package dev.worldgen.world.preview.backend.storage;
...
import static dev.worldgen.world.preview.backend.storage.PreviewStorage.FLAG_STRUCT_START;
...
public class PreviewBlock implements Serializable {
    ...
    private PreviewSection sectionFactory(int quartX, int quartZ) {
        ...
        final int quartStride = WorldPreview.renderSettings().quartStride();
        if (WorldPreview.cfg().enableCompression) {
